<%@ Page Title="" Language="C#" MasterPageFile="~/IndexMaster.master" AutoEventWireup="true" CodeFile="LoginCart.aspx.cs" Inherits="LoginCart" %>
            ...
            <section style="margin-top: 20px;">
                <div id="container_demo">
                    ...
                    <div id="login" class="animate form" runat="server">
                        <div class="wrapper">
                            ...
                            <div class="clsloginpart">
                                ...
                                <asp:TextBox runat="server" ID="txtusername" name="username" type="text" placeholder="CustomerID Or Mobile" CssClass="form-control" />
                                ...
                                <asp:TextBox runat="server" ID="txtpassword" CssClass="form-control" name="password" TextMode="Password" type="password" placeholder="Password" />
                                ...
                                <asp:LinkButton runat="server" ID="lnkforgatepassword" class="to_register pull-right" OnClick="lnkforgatepassword_Click">Forgate Password</asp:LinkButton>
                    ...
                    <div id="ForgatePassword" class="animate form" runat="server" style="display: none">
                        <div class="wrapper">
                            <h1 class="logheader">Forgate Password</h1>
                            <div class="clsloginpart">
                                <label for="username" class="uname">Enter Your Registor Mobile No </label>
                                <asp:TextBox runat="server" ID="txtForgatemoile" name="username" type="text" placeholder="Email Or Mobile" CssClass="form-control" />
                                ...
                                <asp:Button runat="server" ID="btnforgatepass" type="submit" Text="Login" ValidationGroup="forgate" Font-Bold="true" CssClass="btn btn-primary" Style="padding-left: 0px; width: 100%" OnClick="btnforgatepass_Click" />
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <asp:TextBox runat="server" ID="txt_username" name="usernamesignup" type="text" placeholder="User Name" CssClass="form-control" /></td>
                                        ...
                                        <div class="form-group">
                                            <asp:TextBox runat="server" ID="txt_email" type="email" placeholder="Email Address" CssClass="form-control" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox runat="server" ID="txtMobile" name="Mobilesignup" placeholder="Mobile Number" CssClass="form-control" />
                                        ...
                                        <div class="form-group">
                                            <asp:TextBox runat="server" ID="txt_password" CssClass="form-control" name="passwordsignup" TextMode="Password" type="password" placeholder="Password" />
                                        ...
                                        <div class="form-group">
                                            <asp:TextBox runat="server" CssClass="form-control" ID="passwordsignup_confirm" name="passwordsignup_confirm" type="password" TextMode="Password" placeholder="Retype Password" />
                                        ...
                                        <div class="form-group">
                                            <asp:TextBox runat="server" CssClass="form-control" ID="txt_referralid" name="referralid" Text="WINSMART" placeholder="Referral ID" OnTextChanged="txt_referralid_TextChanged" AutoPostBack="true" />
