<%@ Page Title="" Language="C#" MasterPageFile="~/Front.master" AutoEventWireup="true"
    CodeFile="checkout2.aspx.cs" Inherits="checkout2" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- Included Bootstrap CSS Files -->
    <%--  
 <link href="css/style-checkout.css" rel="stylesheet" type="text/css" />
 <link href="css/font-awesome/css/font-awesome.css" rel="stylesheet" type="text/css" />
 <link href="js/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" type="text/css" />
 <link href="js/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />--%>
    <link href="js/bootstrap/css/Checkoutcss.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        .span4
        {
            width: 250px;
        ...
        <div class="accordion" id="accordion2">
                ...
                <div id="collapseOne" class="accordion-body collapse in">
                    <div class="accordion-inner">
                        <div class="span4">
                            ...
                            <br />
                            <asp:Button ID="btnLoginNext" runat="server" CssClass="btn btn-primary" Text="Continue"
                        ...
                        <div class="span4 offset2">
                            ...
                            <label>
                                Contact No</label>
                            <asp:TextBox ID="txtContactNo" runat="server" ToolTip="Please Enter Contact No" MaxLength="20"></asp:TextBox>
                            ...
                            <br />
                            <asp:Button ID="btnRegisterNext" runat="server" Text="Continue" CssClass="btn btn-primary"
            ...
            <div class="accordion-group">
                ...
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <asp:Label ID="lblMessageZIP" runat="server" EnableViewState="False" Font-Bold="True"
                            Style="display: none;"></asp:Label>
                        <label>
                            First Name:</label>
                        <asp:TextBox ID="txtFirstName" runat="server" ToolTip="Please Enter First Name" MaxLength="50"
                            onfocus="clearText(this)" onblur="clearText(this)" CssClass="txt_field_yo" value="Enter First Name"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvFirstName" runat="server" ControlToValidate="txtFirstName"
                            Display="Dynamic" ErrorMessage="Please Enter First Name" SetFocusOnError="True"
                            ValidationGroup="v" InitialValue="Enter First Name">*</asp:RequiredFieldValidator>
                        <label>
                            Last Name:</label>
                        <asp:TextBox ID="txtLastName" runat="server" ToolTip="Please Enter Last Name" MaxLength="50"
                            onfocus="clearText(this)" onblur="clearText(this)" CssClass="txt_field_yo" value="Enter Last Name"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvLastName" runat="server" ControlToValidate="txtLastName"
                            Display="Dynamic" ErrorMessage="Please Enter Last Name" SetFocusOnError="True"
                            ValidationGroup="v" InitialValue="Enter Last Name">*</asp:RequiredFieldValidator>
                        <label>
                            Landmark:</label>
                        <asp:TextBox ID="txtLandmark" runat="server" MaxLength="150" ToolTip="Please Enter Landmark"
                            onfocus="clearText(this)" onblur="clearText(this)" CssClass="txt_field_yo" value="Enter Your Landmark"></asp:TextBox>
                        <label>
                            Address:</label>
                        <asp:TextBox ID="txtAddress" runat="server" EnableTheming="false" Height="100px"
                            TextMode="MultiLine" ToolTip="Please Enter Address" Width="200px" onfocus="clearText(this)"
                        ...
                        <label>
                            City:</label>
                        <asp:TextBox ID="txtCity" runat="server" ToolTip="Please Enter City" MaxLength="50"
                            onfocus="clearText(this)" onblur="clearText(this)" CssClass="txt_field_yo" value="Enter City"></asp:TextBox>
                        ...
                        <label>
                            Post Code:</label>
                        <asp:TextBox ID="txtZip" runat="server" ToolTip="Please Enter ZIP code" MaxLength="4"
                            Width="100px" onfocus="clearText(this)" onblur="clearText(this)" CssClass="txt_field_yo"
                            value="000000"></asp:TextBox>
                        <cc2:FilteredTextBoxExtender ID="txtZip_FilteredTextBoxExtender" runat="server" Enabled="True"
                        ...
                        <asp:DropDownList ID="ddlCountry" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged"
                            CssClass="txt_field_yo" Width="292px">
                        </asp:DropDownList>
                        ...
                        <asp:RequiredFieldValidator ID="rfvState" runat="server" ControlToValidate="ddlState"
                            Display="Dynamic" ErrorMessage="Please Select State" SetFocusOnError="True" ValidationGroup="v">*</asp:RequiredFieldValidator>
                        <br />
                        <asp:Button ID="btnShippingDetail" runat="server" CssClass="btn btn-primary" Text="Continue"
                            ValidationGroup="vs" OnClick="btnShippingDetail_Click" />
                        ...
                        <table width="450px" style="line-height: 25px; border: solid 1px #cfcfcf; padding: 10px;
                                ...
                                <td style="height: 250px;">
                                    <table cellpadding="5" cellspacing="5">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="buttonall">
                                                    <asp:Button ID="btnShippingCalculate" runat="server" Text="Shipping Calculate" OnClick="btnShippingCalculate_Click"
                                                        ValidationGroup="sm" CssClass="image" />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <tr>
                                <td>
                                    <br />
                                    <div class="buttonall">
                                        <asp:Button ID="btnShippingMethod" runat="server" CssClass="image" Text="Continue"
                                            ValidationGroup="vs" OnClick="btnShippingMethod_Click" />
                                    </div>
                                    <asp:LinkButton ID="lnkEditShippingDetails" runat="server" Font-Bold="True" ForeColor="Black"
                                        OnClick="lnkEditShippingDetails_Click">Edit Shipping Details</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table width="450px" style="line-height: 25px; border: solid 1px #cfcfcf; padding: 10px;">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <h3>
                                                    ...
                                                    <asp:Label ID="lblDiscount" runat="server" Font-Bold="True"></asp:Label>% Discount
                                                    on product cost</h3>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                $<asp:Label ID="lblProductCost" runat="server" Font-Bold="True"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                $<asp:Label ID="lblShippingCost" runat="server" Font-Bold="True"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                Discount on Product Cost
                                            </td>
                                            <td>
                                                $<asp:Label ID="lblDiscountCost" runat="server" Font-Bold="True"></asp:Label>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td>
                                    <br />
                                    <div class="buttonall">
                                        <asp:Button ID="btnFinalCheckOut" runat="server" CssClass="image" Text="Proceed to Payment"
